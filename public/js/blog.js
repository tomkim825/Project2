...
//========================================  
  ...
  function createNewRow(post,i) {
    ...
    var newPostCard = $("<div>").addClass('page').css('left',97*i +10+'vw').css('top',-50*i +"vh").css('max-width','75vh').css('height','auto'); //main card. added viewport width positioning to ensure it works correctly
